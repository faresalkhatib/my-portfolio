...
function SocialLink({
  ...
  return (
    <Component
      ...
      whileTap={{ scale: 0.97 }}
      className="w-full group flex items-center gap-4 p-4 rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-slate-700 transition-all duration-300 text-left"
    >
      <div
        className={`p-3 rounded-xl ${color} group-hover:scale-110 transition-all`}
      >
...
`);
  ...
  return (
    <section
      id="contact"
      className="py-24 sm:py-32 relative max-w-7xl mx-auto px-6"
    >
      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          {/* Main Card */}
          <div className="bg-slate-900/50 border border-slate-800 rounded-3xl p-8 sm:p-10 text-center">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 text-white hover:shadow-lg hover:shadow-indigo-500/25 transition-all duration-300"
            >
              <Send size={20} />
          ...
          <motion.div
            ...
            className="flex items-center justify-center gap-4 p-6 rounded-2xl bg-slate-900/50 border border-slate-800"
          >
